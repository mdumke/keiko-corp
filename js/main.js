window.onload = function () {
  ...
  // load additional below-the-fold css
  var loadStylesheet = function (src) {
    if (!document.createStylesheet) return loadStylesheetFallback(src)

    document.createStylesheet(src)
  }

  var loadStylesheetFallback = function (src) {
  ...
  loadStylesheet('css/main-below-the-fold.css')
}
